...
func (c *Controller) updateFooStatus(foo *crdv1.Foo, deployment *appsv1.Deployment) error {
	...
	_, err := c.clientset.controllerV1().Foos(foo.Namespace).Update(context.TODO(), fooCopy, metav1.UpdateOptions{})
	return err
}
...
func newDeployment(foo *crdv1.Foo) *appsv1.Deployment {
	...
	return &appsv1.Deployment{
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				*metav1.NewControllerRef(foo, crdv1.SchemeGroupVersion.WithKind("Foo")),
			},
		},
